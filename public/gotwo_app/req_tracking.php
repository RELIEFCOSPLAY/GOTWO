...
<head>
    ...
    <title>Travel Tracking Details_req</title>
...
<body>
    <div class="wrapper">
        ...
        <script src="/public/js/gotwo_js/req_tracking_nav_animation.js"></script>
        <script src="/public/js/gotwo_js/searchfuction.js"></script>

        <?php
// ดึงข้อมูลจากฐานข้อมูล Rider และ Customer ที่ status_post = 0
$sql = "
